...
const AppContent = () => {
  ...
  // Create user profile from Firebase currentUser
  ...
  const renderContent = () => {
    ...
    switch (currentView) {
      case "Dashboard":
        return <Dashboard user={userProfile} onTopicClick={navigateToTopicOverview} />;
      case "Topics":
      ...
      case "Profile":
        return <Profile user={userProfile} stats={leetcodeStats} onSync={handleSyncComplete} />;
