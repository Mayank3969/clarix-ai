...
import { MOCK_TOPICS, MOCK_LEARNING_PATH, MOCK_USER_STATS } from "../data";
import { Topic, DailyTask, UserProfile } from "../types";
import { fetchDailyTask } from "../api";

export const Dashboard = ({ user, onTopicClick }: { user: UserProfile; onTopicClick: (topic: Topic) => void }) => {
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-8 flex flex-col gap-8">
                 <div className="flex items-center gap-3">
                    <div className="relative">
                        <img src={user.photoURL || `https://api.dicebear.com/7.x/identicon/svg?seed=${user.uid}`} className="w-14 h-14 rounded-full border-2 border-white shadow-md" />
                    ...
                    <div>
                        <h2 className="text-2xl font-black text-slate-900">Welcome back, {user.displayName.split(' ')[0]}</h2>
            ...
            <div className="lg:col-span-4 flex flex-col gap-6">
                 ...
                 <div>
                    <GeminiWidget expertise={user.expertise} />
                 </div>
            </div>
        </div>
