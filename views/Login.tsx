      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-[#0f172a]/70 backdrop-blur-md transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between relative">
          ...
          <div className="hidden md:flex items-center gap-6 z-20">
            <button onClick={() => setShowAuthModal(true)} className="text-sm font-medium text-slate-300 hover:text-white transition-colors">Log In</button>
            <button onClick={() => setShowAuthModal(true)} className="group relative px-6 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full text-sm font-bold text-white shadow-lg shadow-blue-900/50 hover:shadow-blue-900/70 hover:-translate-y-0.5 transition-all duration-300">
              Get Started Free
            </button>
          </div>
        </div>
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 min-h-screen flex flex-col items-center justify-start overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 mb-20">
            <button onClick={() => setShowAuthModal(true)} className="px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full font-bold text-lg shadow-[0_0_40px_-10px_rgba(37,99,235,0.5)] hover:shadow-[0_0_60px_-15px_rgba(37,99,235,0.6)] hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            <div className="max-w-[600px] mx-auto bg-slate-900/50 backdrop-blur-xl border border-blue-500/30 shadow-2xl shadow-blue-900/20 rounded-3xl p-8 md:p-12 relative overflow-hidden group hover:border-blue-500/50 transition-all duration-300">
                ...
                <div className="relative z-10">
                    ...
                    <button onClick={() => setShowAuthModal(true)} className="w-full py-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold rounded-xl shadow-lg shadow-blue-900/40 transition-all transform hover:-translate-y-1">
                        Get Started Now
                    </button>
